                            ...
                            <div className="w-full md:w-1/2 md:px-3">
                                <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl flex flex-col">
                                        ...
                                        <div className="block text-blue-600 xl:inline">Help You Build Faster.</div>
                                    </h1>
                                    ...
                                    <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                                        ...
                                        <Link to="/docs" className="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                                            Learn More
                                        </Link>
                                    </div>
                                </div>
