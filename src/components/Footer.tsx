                    ...
                    <div className="lg:mx-auto text-left col-span-2">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col">
                            <input
                                ...
                                className="shadow-md p-3 outline-0 border border-gray-500 rounded-md w-auto lg:min-w-74 text-black"
